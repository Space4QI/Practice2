...
public class ReviewEntityController {
    ...
    @GetMapping("/reviewsGameUser")
    public List<ReviewEntityDTO> getReviewsByUserNicknameAndGameName(@RequestBody UserGameBondDTO bond){
        return reviewEntityService.getReviewsByUserNicknameAndGameName(bond);
    }
