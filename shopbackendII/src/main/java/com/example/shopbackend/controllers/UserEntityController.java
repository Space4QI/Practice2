...
public class UserEntityController {
    ...
    @GetMapping("/userGameItem")
    public Iterable<UserEntityDTO> getUserByDateByGamePriceByItemQuality(@RequestBody UserGameItemBondDTO bond) {
        return userEntityService.getUserByDateByGamePriceByItemQuality(bond);
    }
